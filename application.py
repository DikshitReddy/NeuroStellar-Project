...
def student_info():
    ...
    cursor = connection.cursor()
    # #updated code for splitting first_name by charindex and substr functions of sql
    # cursor.execute("select id,substring(name, 1, charindex(' ', name) - 1),email,gender,contact,dob,address from Student_Info order by name asc")
